...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">hash-map documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-4a6fcdd3d1e8dad752091c94a3fc2c83"' : 'data-target="#xs-components-links-module-AppModule-4a6fcdd3d1e8dad752091c94a3fc2c83"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-4a6fcdd3d1e8dad752091c94a3fc2c83"' :
                                            'id="xs-components-links-module-AppModule-4a6fcdd3d1e8dad752091c94a3fc2c83"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ReleaseRubricComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ReleaseRubricComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CommunicationPlatform.html" data-type="entity-link">CommunicationPlatform</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/SteamApp.html" data-type="entity-link">SteamApp</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/SteamAppList.html" data-type="entity-link">SteamAppList</a>
                            </li>
                            <li class="link">
